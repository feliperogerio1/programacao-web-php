...
<html lang="en">
    ...
    <body>
        <main class="container">
            <h1>Ferramentas</h1>
            <a href="/tool/insert" class="btn btn-primary">Nova ferramenta</a>
            <?php if(isset($_GET)){?>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $t['subjectname']?></td>
                            <td>
                                <a href='/tool/update/id/<?= $t['idtool']?>' class="btn btn-warning">Alterar</a>
                                <a href='/tool/delete/id/<?= $t['idtool']?>' class="btn btn-danger">Excluir</a>
                            </td>
                        </tr>
                        <?php
                        }
